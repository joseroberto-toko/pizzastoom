        ...
        <SafeAreaView style={styles.container}>
          ...
          <SliderPanel showPanel={true}>
              <View style={styles.content}>
                <Title title={'Tamahos'}/>
                <StepsNav check="size"/>
                <SubTitle title={'Selecione o tamanho abaixo:'}/>
                <FormChecks format="size" />
                <View style={styles.btnBox}>
                  <TouchableOpacity style={styles.btn} onPress={() => navigate('Revision')}>
